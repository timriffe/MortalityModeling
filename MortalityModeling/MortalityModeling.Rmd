...
# Overview
Mortality modeling has mainly grown in its ability to capture mortality changes over age and time. The first who explicitly modeled mortality was Grant in 1662. The author, through an empirical life table, analyzed mortality conditions in London. From Grant (1662) to date, models have become more sophisticated and complex.
