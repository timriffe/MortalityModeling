...
```{r Gompertz, echo = FALSE, message = FALSE, warning = FALSE, fig.cap="Observed and fitted death rates using a log-linear (Gompertz) model for males aged 40 to 100 in Switzerland in the year 2010 (data: HMD).", fig.width = 7, fig.height=7}
...
par(xaxs="i",yaxs="i")
plot(x, LX[,1],type="n",xlab="Age",ylab="", las = 1, cex.lab = 1.75)
